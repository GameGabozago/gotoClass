...
public class Boss : Enemy
{
    ...
    IEnumerator Think()
    {
        yield return new WaitForSeconds(0.1f); //�̰� ������� ���� ������ ������
    ...
    IEnumerator MissileShot()
    {
        ...
        StartCoroutine(Think()); // ������ ������ ���� ������ ���� �ٽ� Think() �ڷ�ƾ ����
    }
